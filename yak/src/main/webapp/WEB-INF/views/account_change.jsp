            ...
            <div class="card card-2">
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="input-groupp">
                            <input class="input--style-2" type="text" placeholder="이름" name="name">
                        </div>
                        ...
                        <div class="p-t-30">
                            <button class="btn btn--radius btn--green" type="submit">수정 완료</button> <button class="btn btn--radius btn--green" type="submit">취소</button>
                        </div>
                    </form>
                </div>
            </div>
