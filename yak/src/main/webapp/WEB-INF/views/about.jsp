			...
			<div class="row">
				<div class="col">
					<div class="homee_content">
						...
						<div class="homee_title">About us</div>		
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row row-lg-eq-height">
				...
				<div class="col-lg-6 order-lg-1 order-2">
					<div class="about_image d-flex flex-column align-items-center justify-content-center">
						<img src="resources/images/drug.jpg" alt="">
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<div class="section_title"><h2>우리를 소개합니다</h2></div>
						<div class="team_text">
							<p>주소 : 경기도 의정부시 서부로 545, 경민대학교</p>
							<p>대표번호 : 031-828-7700</p>
						</div>
					</div>
				</div>
			</div>
			<div class="row team_row">
				...
				<div class="col-xl-3 col-md-6">
					<div class="team_item">
						<div class="team_image">
							<img src="resources/images/team_1.jpg" alt="https://unsplash.com/@michaeldam">
						...
						<div class="team_content text-center">
							<div class="team_name">이종열</div>
							<div class="team_title">조장</div>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-3 col-md-6">
					<div class="team_item">
						<div class="team_image">
							<img src="resources/images/team_2.jpg" alt="https://unsplash.com/@stairhopper">
							<div class="team_overlay trans_400"></div>
							<div class="team_social">
								<ul class="d-flex flex-row align-items-center justify-content-between">
									<li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						...
						<div class="team_content text-center">
							<div class="team_name">이재원</div>
							<div class="team_title">조원</div>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-3 col-md-6">
					<div class="team_item">
						<div class="team_image">
							<img src="resources/images/team_3.jpg" alt="https://unsplash.com/@chrisjoelcampbell">
							<div class="team_overlay trans_400"></div>
							<div class="team_social">
								<ul class="d-flex flex-row align-items-center justify-content-between">
									<li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
				...
				<div class="col-xl-3 col-md-6">
					<div class="team_item">
						<div class="team_image">
							<img src="resources/images/team_4.jpg" alt="https://unsplash.com/@brookecagle">
							<div class="team_overlay trans_400"></div>
							<div class="team_social">
								<ul class="d-flex flex-row align-items-center justify-content-between">
									<li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						...
						<div class="team_content text-center">
							<div class="team_name">박남일</div>
							<div class="team_title">지도교수</div>
						</div>
					</div>
				</div>
